...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.eval_factify \
        ...
        --question-file /home/zehong/LLaVA/data/Factify2/data/factify2/val.csv \
        --image-folder /home/zehong/LLaVA/data \
        --answers-file /home/zehong/LLaVA/outputs/eval/factify2/$SPLIT/$CKPT/${CHUNKS}_${IDX}.jsonl \
        --num-chunks $CHUNKS \
        --chunk-idx $IDX &
done
...
output_file="/home/zehong/LLaVA/outputs/eval/factify2/$SPLIT/$CKPT/merge.jsonl"
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    cat /home/zehong/LLaVA/outputs/eval/factify2/$SPLIT/$CKPT/${CHUNKS}_${IDX}.jsonl >> "$output_file"
done
